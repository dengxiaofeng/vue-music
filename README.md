...
#### src目录结构
![](https://bck-pro.oss-cn-beijing.aliyuncs.com/71529472.jpg)
...
![](https://bck-pro.oss-cn-beijing.aliyuncs.com/75828095.jpg)
...
在请求JSONP的时候，用到了一个JSONP库，这个库代码十分简短，只有几十行，有兴趣的同学可以[学习](https://github.com/dengxiaofeng/jsonp.git)下。
...
#### 交互体验
该项目的很多地方都涉及到滚动，包括下拉滚动，下拉滚动刷新等。这里面用到了一个库(`better-scroll`)
